...
class BlueNavigationController: UINavigationController {
	...
	override func viewDidLoad() {
		super.viewDidLoad()
		self.gradient.colors = [#colorLiteral(red: 0, green: 0.04379742189, blue: 0.542300842, alpha: 1).cgColor, #colorLiteral(red: 0.1380140068, green: 0.3756803633, blue: 0.8507124352, alpha: 1).cgColor]
