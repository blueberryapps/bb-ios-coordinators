...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BBCoordinators.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/David Lenský/BBCoordinators'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'David Lenský' => 'david.lensky.77@gmail.com' }
  s.source           = { :git => 'https://github.com/David Lenský/BBCoordinators.git', :tag => s.version.to_s }
